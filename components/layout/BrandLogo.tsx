...
export default function BrandLogo({ navbar = false, }) {
        ...
        >
            <div className="flex h-full aspect-square items-center justify-center rounded-full bg-green-500 ">
                <svg
                    className={cn(
                        "text-yellow-500",
                        navbar ? 'h-5' : 'h-6 md:h-11 w-6 md:w-11',
                    )}
            ...
            <div
                className={cn(
                    "flex flex-col  leading-none uppercase  tracking-wide ",
                    navbar ? 'text-lg px-2 pr-4 ' : 'text-2xl md:text-4xl px-2 md:px-4 pr-6 md:pr-8',
                )}
            >
                Completed It Mate
            </div>
