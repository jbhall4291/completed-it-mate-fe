    ...
    return (
        <div
            className={cn(
                ...
                "rounded-2xl px-7 pt-2 pb-2.5 bg-green-500 text-white shadow-[0_6px_24px_rgba(16, 185, 129, .25)]",
                shimmer && "shimmer",

            )}
        >
            <Crown strokeWidth={2.5} className="text-[#ffdd00] h-5.5 w-5.5 md:h-11 md:w-11" />
